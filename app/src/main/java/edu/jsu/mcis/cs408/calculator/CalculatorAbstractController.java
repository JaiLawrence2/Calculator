...
public abstract class CalculatorAbstractController implements PropertyChangeListener {
    private ArrayList<AbstractMainActivityView> views;
    private ArrayList<CalculatorAbstractModel> models;
    public CalculatorAbstractController() {
    ...
    public void addView(AbstractMainActivityView view) {
        views.add(view);
    }

    public void addModel(CalculatorAbstractModel model) {
        /*
    ...
    public void removeView(AbstractMainActivityView view) {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        for (AbstractMainActivityView view : views) {
    ...
    protected void setModelProperty(String propertyName, Object newValue) {
        ...
        for (CalculatorAbstractModel model : models) {
